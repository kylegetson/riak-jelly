...
riakEasy.prototype.decrementCounter = function (bucket, bucketType, key, val, callback) {
  this.incrementCounter(bucket, bucketType, key, -Math.abs(val), callback);
};
/**
 * sets
 */
...
riakEasy.prototype.sadd = function (bucket, bucketType, key, addItems, callback) {
  this.updateSet(bucket, bucketType, key, addItems, [], callback);
};

riakEasy.prototype.srem = function (bucket, bucketType, key, removeItems, callback) {
  this.updateSet(bucket, bucketType, key, [], removeItems, callback);
};
...
riakEasy.prototype.updateRegisters = function (bucket, bucketType, key, object, callback) {
...
riakEasy.prototype.removeRegisters = function (bucket, bucketType, key, registerArr, callback) {
